...
- 当前待发布版本：`v0.1.7`
- 当前扩展版本号：`0.1.7`
- Release 文案文件：`docs/releases/v0.1.7.md`
- GitHub Release 正文可直接复制 `docs/releases/v0.1.7.md`
...
```powershell
git status
git add manifest.json sidepanel/sidepanel.html sidepanel/update-service.js sidepanel/sidepanel.js docs/releases/v0.1.7.md RELEASING.md
git commit -m "Prepare v0.1.7 release"
git tag -a v0.1.7 -m "GuJumpgate v0.1.7"
